...
//------------------------------------------------
const indexContents = `import * as React from 'react'
...
const storiesContents = `import * as React from 'react'
...
const specContents = `import * as React from 'react'
...
fs.writeFile(`${path}/index.tsx`, indexContents, (err) => {
  if (err) console.error(err);
});

console.log('Writing Storybook Stories');
fs.writeFile(`${path}/${newComponent}.stories.tsx`, storiesContents, (err) => {
  if (err) console.error(err);
});

console.log('Writing Specs');
fs.writeFile(`${path}/${newComponent}.spec.tsx`, specContents, (err) => {
  if (err) console.error(err);
});
...
console.warn(
  chalk.red('Do not forget to update index.ts to export your new component.'),
);
console.log(
  chalk.yellow('Add the following to the imports section of index.ts\n'),
);
console.log(`  import ${newComponent} from './components/${newComponent}'\n`);
console.log(
  chalk.yellow(`Then include ${newComponent} in the export declaration`),
);
console.log('\n\n');
